...
#book names
titles <- c("Philosophers_stone",Chamber ofSecrets","prisoner of Azkaban",
            "Goblet of Fire","Order of Phoenix","Half-Blood Prince","Deathly Hallows")
...
books <- list(philosophers_stone,chamber_of_secrets,prisoner_of_azkaban,
            goblet_of_fire,order_of_phoenix,half_blood_prince,deathly_hallows)
View(books)
books
...
for(i in seq_along(titles)) {
  ...
  unnest_tokens(words, text) %>% mutate(book = titles[i]) %>%
...
#Visualising sentiment comparison
